...
| [geocompr:geocompy](https://hub.docker.com/r/geocompr/geocompr)          | rocker/geospatial:conda with Python packages installed with Miniconda  | ![](https://img.shields.io/docker/image-size/geocompr/geocompr/conda)     |
| [geocompr:geocompy](https://hub.docker.com/r/geocompr/geocompr)          | rocker/geospatial:mamba with Python packages installed with MicroMamba | ![](https://img.shields.io/docker/image-size/geocompr/geocompr/mamba)     |
