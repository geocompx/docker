...
| [geocompr:minimal](https://hub.docker.com/r/geocompr/geocompr/minimal)   | rocker/geospatial plus minimal (Imports) geocompkg packages | ![](https://img.shields.io/docker/image-size/geocompr/geocompr/minimal)     |
| [geocompr:suggests](https://hub.docker.com/r/geocompr/geocompr/suggests) | rocker/geospatial plus minimal (Imports) geocompkg packages | ![](https://img.shields.io/docker/image-size/geocompr/geocompr/suggests)    |
...
| [geocompr:qgis-min](https://hub.docker.com/r/geocompr/geocompr)          | geocompr/geocompr with just QGIS + **qgisprocess**          | ![](https://img.shields.io/docker/image-size/geocompr/geocompr/qgis-ext)    |
