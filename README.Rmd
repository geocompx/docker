...
# latest lives at root Dockerfile, others in subdirectories
source_code_urls = ifelse(
  img_names == "latest",
  paste0("https://github.com/geocompx/docker/blob/master/Dockerfile"),
  paste0("https://github.com/geocompx/docker/blob/master/", img_names, "/Dockerfile")
)
