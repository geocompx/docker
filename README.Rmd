...
[mamba-py](https://github.com/geocompx/docker/blob/master/)            |  docker pull ghcr.io/geocompx/mamba-py | ![](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/geocompx/docker/gh-pages/badges/mamba-py-size.json)
[mamba-pyr](https://github.com/geocompx/docker/blob/master/)            |  docker pull ghcr.io/geocompx/mamba-pyr | ![](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/geocompx/docker/gh-pages/badges/mamba-pyr-size.json)
